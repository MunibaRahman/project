...
class Balloon{
  constructor(x,y,z){
	...
	this.checkpoint2 = new CheckPoint(balloon1, this.x, this.y -10, this.z);// here you have to change the this.x,this.y,this.z to be the values where you want the next checkpoint to be
